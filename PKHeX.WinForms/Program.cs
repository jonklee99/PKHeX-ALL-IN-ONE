...
internal static class Program
{
    ...
    // Store the full version string including revision tags for update checking
    public static readonly string CurrentVersionString = Application.ProductVersion;
