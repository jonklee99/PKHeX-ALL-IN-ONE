        ...
        IMetLevel, IRestrictVersion, IRibbonSetEvent3, IRibbonSetEvent4
{
    ...
    public override PB7 ConvertToPKM(ITrainerInfo tr, EncounterCriteria criteria)
    {
        ...
        var date = IsDateRestricted && EncounterServerDate.WB7Gifts.TryGetValue(CardID, out var dt) ? dt.Start : EncounterDate.GetDateSwitch();
        pk.MetDate = date;
    ...
    public bool IsDateRestricted => CardID >= 9000;
